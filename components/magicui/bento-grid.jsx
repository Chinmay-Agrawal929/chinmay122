...
const BentoCard = ({
  ...
  >
    ...
    <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300">
      ...
      <p className="max-w-lg text-neutral-400 group-hover:opacity-0 transition-opacity duration-300">
        {description}
      </p>
    </div>
    ...
    <div
      className={cn(
        ...
        "bg-gradient-to-t from-white/100 to-transparent dark:from-black/100 dark:to-transparent"
      )}
    >
      <Button
        variant="ghost"
